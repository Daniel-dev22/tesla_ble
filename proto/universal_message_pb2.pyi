...
class RoutableMessage(_message.Message):
    __slots__ = ["flags", "from_destination", "protobuf_message_as_bytes", "request_uuid", "session_info", "session_info_request", "signature_data", "signedMessageStatus", "to_destination", "uuid"]
...
class SessionInfoRequest(_message.Message):
    __slots__ = ["challenge", "public_key"]
